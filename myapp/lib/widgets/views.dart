...
class _ViewsPageState extends State<ViewsPage> {
  ...
  Future<void> fetchReviews() async {
    final response = await http.get(Uri.parse(
        'http://10.39.5.8:3000/api/reviews/${widget.category}/${widget.place_id}'));
  ...
  Future<void> addReview(String reviewText, double rating) async {
    ...
    final url = Uri.parse("http://10.39.5.8:3000/api/reviews");
  ...
  Future<void> deleteReview(int reviewId) async {
    ...
    final url = Uri.parse("http://10.39.5.8:3000/api/reviews/$reviewId");
                          ...
                          return ListTile(
                            leading: CircleAvatar(
                              backgroundImage: review['profile_image'] != null
                                  ? NetworkImage(
                                      'http://10.39.5.8:3000${review['profile_image']}')
